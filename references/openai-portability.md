# OpenAI portability contract — Project Setup
...
- ChatGPT desktop: enable the plugin in a chat, then ask naturally or use `@Project Setup <request>`.
...
When Drive or project-creation APIs are absent, return a folder blueprint and a host-neutral workspace prompt for manual creation. Cortex writes are optional and require confirmation.
