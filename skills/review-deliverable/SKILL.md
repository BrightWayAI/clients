...
Before running the review, confirm `<config-root>/plugins/ops.user-context.md` exists. If it doesn't, route to `/setup-core` first — the review is much sharper with brand context loaded.
